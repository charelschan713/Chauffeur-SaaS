...
function AddCardForm({ onSuccess, onCancel }: { onSuccess: () => void; onCancel: () => void }) {
  ...
  return (
    <div className="rounded-2xl bg-white border border-gray-100 p-4 space-y-4">
      <p className="text-sm font-medium text-[#1a1a1a]">Add New Card</p>
      ...
      <div className="flex gap-3">
        ...
        <button onClick={onCancel}
          className="px-4 py-2.5 rounded-xl border border-gray-100 text-gray-500 text-sm hover:text-[#1a1a1a] transition-colors">
          Cancel
        </button>
      </div>
    </div>
      ...
      {confirmDelete && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 p-4">
          <div className="w-full max-w-sm bg-[hsl(228,12%,12%)] border border-gray-100 rounded-2xl p-5 space-y-4">
            ...
            <p className="text-xs text-gray-500">This card will be removed from your account.</p>
            <div className="flex gap-3">
              ...
              <button onClick={() => setConfirmDelete(null)}
                className="flex-1 py-2.5 rounded-xl border border-gray-100 text-gray-500 text-sm">
                Cancel
              </button>
            </div>
          </div>
